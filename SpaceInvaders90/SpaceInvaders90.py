...
pyglet.font.add_file('NiseMegaDriveEU.ttf')
import os
import time
import random
import json
import pygame # For music and sounds effects only
pygame.mixer.init()
...
class Game(object):
    ...
    def __init__(self, frame, root):
        ...
        self.player_score = self.canvas.create_text(120, 30, text = 'SCORE     '+str(Constantes.SCORE), fill = 'white', font = ('NiseMegaDriveEU', 10))
        self.best_score = self.canvas.create_text(Constantes.WIDTH_GAME_WINDOW-150, 30, text = 'HI-SCORE     '+str(Constantes.HIGHEST_SCORE), fill = 'white', font = ('NiseMegaDriveEU', 10))
        ...
        # For music
        pygame.mixer.music.load('rounds.mp3')
...
class TitleScreen(object):
    ...
    def appear_press_start(self):
        self.press_space = self.canvas.create_text(Constantes.WIDTH_GAME_WINDOW/2, 400, text = 'PRESS SPACE', fill = 'white', font = ('NiseMegaDriveEU', 10))
    ...
    def appear_scores(self):
        ...
        for each_of_top5 in sorted_scores:
            self.player_name_top = self.canvas.create_text(Constantes.WIDTH_GAME_WINDOW/2 - 100, 220+i, text = (each_of_top5), fill = 'grey', font = ('NiseMegaDriveEU',10))
            self.player_score_top = self.canvas.create_text(Constantes.WIDTH_GAME_WINDOW/2 + 100, 220+i, text = str(all_scores[each_of_top5]), fill = 'grey', font = ('NiseMegaDriveEU',10))
            i = i+20
        ...
        self.best_score = self.canvas.create_text(Constantes.WIDTH_GAME_WINDOW-150, 30, text = 'HI-SCORE     '+str(Constantes.HIGHEST_SCORE), fill = 'white', font = ('NiseMegaDriveEU', 8))
...
class SegaLogo(object):
    ...
    def appear_title(self):
        ...
        pygame.mixer.music.load('sega_sound.mp3')
...
class GameOver(object):
    ...
    def appear_infos(self):
        # Display Game Over
        self.game_over_title = self.canvas.create_text(Constantes.WIDTH_GAME_WINDOW/2, 120, text = 'GAME OVER', fill = 'grey', font = ('NiseMegaDriveEU',15))
        # Display if Win or Loose
        if Constantes.GameOverState == 1:
            # Case of Win
            self.game_over_state = self.canvas.create_text(Constantes.WIDTH_GAME_WINDOW/2, 140, text = 'VICTORY', fill = 'grey', font = ('NiseMegaDriveEU',12))
        if Constantes.GameOverState == 2:
            # Case of Loose
            self.game_over_state = self.canvas.create_text(Constantes.WIDTH_GAME_WINDOW/2, 140, text = 'DEFEAT', fill = 'grey', font = ('NiseMegaDriveEU',15))
        # Display player score:
        self.player_score = self.canvas.create_text(Constantes.WIDTH_GAME_WINDOW/2, 180, text = 'SCORE     '+str(Constantes.SCORE), fill = 'white', font = ('NiseMegaDriveEU', 10))
        # Music
        pygame.mixer.music.load('final_round.mp3')
        pygame.mixer.music.play()
        # Enter Player Name:
        self.enter_player_name = self.canvas.create_text(Constantes.WIDTH_GAME_WINDOW/2, 200, text = 'ENTRY PLAYER NAME', fill = 'white', font = ('NiseMegaDriveEU', 10))
        # 3 Letters to choose as Player name:
        self.letter1 = self.canvas.create_text(Constantes.WIDTH_GAME_WINDOW/2-50, 300, text = 'A', fill = 'white', font = ('NiseMegaDriveEU', 14))
        self.letter2 = self.canvas.create_text(Constantes.WIDTH_GAME_WINDOW/2, 300, text = 'A', fill = 'white', font = ('NiseMegaDriveEU', 14))
        self.letter3 = self.canvas.create_text(Constantes.WIDTH_GAME_WINDOW/2+50, 300, text = 'A', fill = 'white', font = ('NiseMegaDriveEU', 14))
        # The arrows are on first letter by default:
        self.arrow1 = self.canvas.create_text(Constantes.WIDTH_GAME_WINDOW/2-50, 240, text = '↑', fill = 'white', font = ('NiseMegaDriveEU', 10))
        self.arrow2 = self.canvas.create_text(Constantes.WIDTH_GAME_WINDOW/2-50, 360, text = '↓', fill = 'white', font = ('NiseMegaDriveEU', 10))
        # List of items
        self.list_of_letters_widgets = [self.letter1, self.letter2, self.letter3]
        # Press Space to confirm
        self.press_space_to_confirm = self.canvas.create_text(Constantes.WIDTH_GAME_WINDOW/2, 440, text = 'Press Space to Confirm', fill = 'white', font = ('NiseMegaDriveEU', 10))
